  ...
  <title>Mis notas.com</title>
    ...
    <nav class="navbar navbar-expand-md navbar-expand-lg navbar-dark bg-dark"> 
        ...
        <?php
            ...
            $nombre_n = $notasE['nombre_n'];
            $texto = $notasE['texto'];
            $prioridad = $notasE['prioridad'];
        ?>
        <div class="container m-5">
            <div class="row">
                <div class="col">
                    <legend>
                        <table class="table table-light table-striped m-auto">
                            <thead>
                            <tr>
                                <th>Usuario</th>
                                <th>Fecha de Creacion</th>
                                <th>Ultima fecha de actualizacion</ht>
                                <th><a href="e_notes.php?id=<?=$id?>&name=<?=$nombre_n?>&text=<?=$texto?>&priority=<?=$prioridad?>" role="button">
                                ...
                                <td colspan="5" align="center"><?=$notasE['texto']?></td>
                            </table>
                        </legend>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        <p><a style="text-decoration: none;" role="button" class="btn btn-info" href="../main_notes.php">Mis notas</a></p>
                    </div>
                </div>
            </div>
