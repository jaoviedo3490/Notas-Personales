                        ...
                        <div class="card" style="width:230px">
                            <div class="card-header"><h5 class="card-title">Nombre: <?=$notasE['nombre']?></h5></div>
                                <div class="card-body">
                                    ...
                                    <a href="Notas_user/v_notes.php?id=<?=$notas_id?>" class="btn btn-lg btn-outline-dark card-link">
        ...
        <div class="row ">
            <div class="caja m-5 pb-2 w-50">
                <div class="col justify-content-center">
                        <button class="btn btn-success btn-lg m-2" onclick="window.location = 'Notas_user/n_notes.php' ">Nueva nota</button>
                </div>
            </div>
        </div>
    </div>
